...
private:
    ...
    void loadFromFile() {
        ...
        if (!file.is_open()) {
            cout << "[提示] 未找到历史数据文件，将创建新通讯录" << endl;
            return;
        }
        ...
        file.close();
        cout << "[成功] 成功加载 " << contacts.size() << " 个联系人" << endl;
    }
...
public:
    ...
    void deleteContact() {
        ...
        if (confirm == 'y' || confirm == 'Y') {
            contacts.erase(it);
            cout << "[成功] 联系人删除成功！" << endl;
        } else {
            cout << "[取消] 删除操作已取消" << endl;
        }
    }
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 0:
                ...
                return 0;
            default:
                cout << "[错误] 输入错误，请选择 0-5 之间的数字！" << endl;
        }
